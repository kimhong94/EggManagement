		...
		<section class="container">
			<div class="container-page">
				<div class="col-md-6">
					...
					<div class="form-group col-lg-12">
						<label>배송업체ID</label>
						<input type="text" name="" class="form-control" id="did" value="${login.deliverVO.deliverid}" disabled>
					</div>
					<div class="form-group col-lg-12">
						<label>배송업체</label>
						<input type="text" name="" class="form-control" id="dcompany" value="${login.deliverVO.dcompany}" disabled>
					</div>
					<div class="form-group col-lg-12">
						<label>배송자</label>
