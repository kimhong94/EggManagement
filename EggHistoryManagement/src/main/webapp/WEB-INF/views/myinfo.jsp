...
<link href="/egg/resources/bootstrap-3.3.2/css/bootstrap.min.css"
	rel="stylesheet" type="text/css" />
<link href="/egg/resources/bootstrap-3.3.2/js/bootstrap.min.js"
	rel="stylesheet" type="" />
<link rel="stylesheet"
...
<link rel="mask-icon" type=""
	...
	color="#111" />
<link rel="canonical"
	href="https://codepen.io/suez/pen/OjGQza?depth=everything&limit=all&order=popularity&page=59&q=icon&show_forks=false" />
...
<body>
	<div class="wrapper">
		<nav>
		<div class="logo">
			<a href="myinfo"><h1>계란 이력관리</h1></a>
		</div>
		<div class="menu">
			<ul>
				<li class="active"><a href="Main">주문하기</a>
				<li class="submenu"><a href="deliverhome">계란 정보</a>
				<li class="submenu"><a href="CustomMain">이력관리 정보</a>
				<li class="submenu"><a href="MainMainMain">고객지원</a>
			</ul>
		</div>
		</nav>
		...
		<div id="rightMenu" style="position: fixed; top: 150px; left:94%;"><a href="Main"><img src="https://www.farm2table.kr/img/right_menu01.png" alt="소비자 홈페이지 바로가기"></a>
  <div class="space06"></div><br>
  <a href="Main"><img src="https://www.farm2table.kr/img/right_menu02.png" alt="유통/생산자 홈페이지 바로가기"></a></div>
		<section class="about">
		<h1>QR Code</h1>
		<div class="about_para">
			<p id="info_para">&nbsp요즘은 QR코드로 계란에 대한 정보만 확인하는 시대가 아닙니다. 고객 여러분
				계란이 어떠한 곳에서 생산 되었으며 어떤 과정으로 유통이 되었는 지 추가적으로 확인 하고 싶으시면 지금 바로 계란에 부착된
				QR코드를 아래 버튼을 누르시고 인식기에 확인해 보십시오!</p>
			<a href="CustomHelp">QR More</a>
		</div>
		<div class="about_img">
			<img
				src="https://us.123rf.com/450wm/llesia/llesia1508/llesia150800142/44490419-scan-qr-code-to-mobile-phone-electronic-scan-digital-technology-barcode-vector-illustration.jpg?ver=6"
				alt="About" title="web design" />
		</div>
		</section>
	</div>
	<script
	...
	<script
		src='https://cdnjs.cloudflare.com/ajax/libs/react/15.6.1/react.min.js'></script>
	<script
